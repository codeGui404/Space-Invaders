...
level_surface = font.render("Nivel 01", False, YELLOW)
game_over_surface = font.render("Game Over", False, YELLOW)
score_text_surface = font.render("SCORE", False, YELLOW)
highscore_text_surface = font.render("HIGHSCORE", False, YELLOW)

screen = pygame.display.set_mode((screen_widht + OFFSET, screen_height + 2*OFFSET))
pygame.display.set_caption("Python Space Invaders")

clock = pygame.time.Clock() 

game = Game(screen_widht, screen_height, OFFSET)
...
while True:
    ...
    for obstaculo in game.obstaculos:
        obstaculo.blocks_group.draw(screen) 
